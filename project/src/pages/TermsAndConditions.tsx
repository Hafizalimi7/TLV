    ...
    <div className="bg-gray-50 min-h-screen py-12 px-6">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg space-y-8">
        ...
        <p className="text-md pb-3 text-gray-700">
          Welcome to The Life Voyage. We are dedicated to supporting your holistic health journey and are delighted to provide services designed to help you achieve balance, wellness, and harmony. The Life Voyage is a trading name for [Your Company Name], a company registered in [Your Country/Region] under company number [Your Registration Number], whose registered address is [Your Address], hereinafter referred to as ‘The Life Voyage’ or ‘we.’ These Terms & Conditions (the ‘Terms’) govern the relationship between The Life Voyage and ‘you,’ the user of our services. Please read these terms carefully as they constitute a legally binding contract.
        </p>
        ...
        <section>
          ...
          <p className="text-md pb-3 text-gray-700">
            These terms are governed by the laws of [Your Country/Region]. Any disputes will be resolved in the courts of [Your Country/Region].
          </p>
        </section>
